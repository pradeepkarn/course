...
$admin_routes = [
    ...
    '/admin/courses/create' => 'Course_admin_ctrl@create@name.courseCreate',
    '/admin/courses/create/save-by-ajax' => 'Course_admin_ctrl@save@name.courseStoreAjax',
    '/admin/courses/list' => 'Course_admin_ctrl@list@name.courseList',
    '/admin/courses/trash-list' => 'Course_admin_ctrl@trash_list@name.courseTrashList',
    '/admin/courses/edit/{id}' => 'Course_admin_ctrl@edit@name.courseEdit',
    '/admin/courses/delete-more-img-ajax' => 'Course_admin_ctrl@delete_more_img@name.courseDeleteMoreImgAjax',
    '/admin/courses/trash/{id}' => 'Course_admin_ctrl@move_to_trash@name.courseTrash',
    '/admin/courses/restore/{id}' => 'Course_admin_ctrl@restore@name.courseRestore',
    '/admin/courses/delete/{id}' => 'Course_admin_ctrl@delete_trash@name.courseDelete',
    '/admin/courses/edit/{id}/save-by-ajax' => 'Course_admin_ctrl@update@name.courseUpdateAjax',
    '/admin/courses/toggle-marked-page' => 'Course_admin_ctrl@toggle_trending@name.courseToggleMarked',
    // Sliders
