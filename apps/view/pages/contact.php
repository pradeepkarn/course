            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title text-center mb--60">
                        ...
                        <h2 class="title">Mdarsa Course Contact <br> can join with us.</h2>
                    </div>
                </div>
            </div>
            <div class="row g-5">
    ...
    <div class="rbt-contact-address">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6">
                    <div class="thumbnail">
                        <img class="w-100 radius-6" src="/<?php echo STATIC_URL; ?>/view/assets/images/about/contact.jpg" alt="Contact Images">
                    </div>
                </div>
