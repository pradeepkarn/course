    ...
    <div class="popup-mobile-menu">
        <div class="inner-wrapper">
            <div class="inner-top">
                ...
                <p class="description">Mdarsa is a education website. You can customize all.</p>
                        ...
                        <div class="rbt-card variation-01 rbt-hover">
                            ...
                            <div class="rbt-card-body">
                                ...
                                <ul class="rbt-meta">
                                    ...
                                    <li><a href="lesson.html"><i class="feather-play-circle">Demo Live Session</i></a></li>
                                </ul>
                        ...
                        <div class="rbt-card variation-01 rbt-hover">
                            ...
                            <div class="rbt-card-body">
                                ...
                                <ul class="rbt-meta">
                                    <li><i class="feather-book"></i>12 Lessons</li>
                                    <li><i class="feather-users"></i>50 Students</li>
                                    <li><a href="lesson.html"><i class="feather-play-circle">Demo Class</i></a></li>
                                    <li><a href="lesson.html"><i class="feather-play-circle">Demo Live Session</i></a></li>
                                </ul>
